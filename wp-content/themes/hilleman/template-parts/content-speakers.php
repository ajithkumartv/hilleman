...
$pod        =   pods( 'speakers', get_the_id() );
$related    =   $pod->field( 'speakers' );
                    ...
                    { 
                        ...
                        <div class="hl-tile-director">
                            ...
                            <div class="hl-tile-director__cnt">
                                ...
                                <?php endif; ?>
                                <a href="javascript: void(0);" title="View Profile" class="hl-btn" data-bs-toggle="modal" data-bs-target="#director-<?php echo $id; ?>">View Speaker Profile<svg viewBox="0 0 16 16" fill="none"
